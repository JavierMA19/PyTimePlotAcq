...
console_scripts = ['GFETTimePlot = PyTimePlot.PyTimePlot:main',
                  ]
...
setup(name="PyTimePlot",
      ...
      url="https://github.com/jmartinezaguilar/PyTimePlot",
      download_url="https://github.com/jmartinezaguilar/PyTimePlot",
      license="GPLv3",
